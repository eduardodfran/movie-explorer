...
export default function MovieItemLoading() {
  return (
    <div className="flex flex-col items-center space-y-4 p-4">
      ...
      <h1>Loading...</h1>
      <div className="bg-gray-300 h-3/4 mb-4 rounded-2xl"></div>
      <div className="bg-gray-300 h-6 mb-2 w-3/4 rounded-2xl"></div>
      <div className="bg-gray-300 h-4 w-1/2 rounded-2xl"></div>
    </div>
  )
}